"""DSpark → RWKV · 阶段11: CUDA 加速 target 的 K-state 投机解码

基于 stage10,但 target 换成 stage11_cuda_target.RWKV7Target2p9BCuda(Albatross faster3a)。
CUDA kernel `wkv_seq` 替代 Python for 循环,消除 T 维度串行开销。
...
from stage11_cuda_target import RWKV7Target2p9BCuda as RWKV7Target2p9B, DTYPE
from stage9_logit_fusion_01b import RWKV7Draft, TARGET_WEIGHTS, LAMBADA_FILE, DEVICE
